...
MAIN_MENU_VARIANT_TEXT = "Выберите вариант"
BEST_DEALS_NEXT_STEP_TEXT = "Выберите следующий шаг:"

HOME_MENU_TEXT = (
    "<b>Что может делать этот бот?</b>\n\n"
    "AutoPartnerBot создан, чтобы помочь вам подобрать автомобиль или мотоцикл!\n"
    "Все просто — нажмите кнопку «Старт», и бот проведет вас по основным разделам.\n\n"
    "<b>Ниже представлено меню, которое проведет вас по основным разделам бота ⤵️</b>"
)

MOTO_INTRO_FALLBACK_TEXT = (
    "🏍️ Добро пожаловать в мото-бот Autopartner!\n"
    "Подберем для вас идеальный мотоцикл под нужный бюджет:"
)
MOTO_HINT_FALLBACK_TEXT = (
    "💬 Выберите бюджет, который вам интересен, и мы найдем\n"
    "лучшие варианты!"
)
MOTO_MODEL_RESOLVE_ERROR_TEXT = "Не удалось определить модель мото."
