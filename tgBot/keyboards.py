...
def get_price_range_keyboard() -> types.InlineKeyboardMarkup:
    kb = InlineKeyboardBuilder()
    kb.button(text="👉 9 000$ - 12 000$", callback_data="price:9_12k")
    kb.button(text="👉 12 000$ - 15 000$", callback_data="price:12_15k")
    kb.button(text="👉 15 000$ - 20 000$", callback_data="price:15_20k")
    kb.button(text="👉 20 000$ - 30 000$", callback_data="price:20_30k")
    kb.button(text="👉 30 000$+ (люкс)", callback_data="price:30k_plus_lux")
    kb.button(text="😍 Самые выгодные авто", callback_data="price:best_deals")
    kb.button(text="😍 Электрокары", callback_data="price:electric")
    kb.adjust(1, 1, 1, 1, 1, 1, 1)
    return kb.as_markup()

def get_budget_9_12_models_keyboard() -> types.InlineKeyboardMarkup:
    kb_from_json = _get_auto_models_keyboard("9_12k")
    if kb_from_json:
        return kb_from_json
...
def get_budget_12_15_models_keyboard() -> types.InlineKeyboardMarkup:
    kb_from_json = _get_auto_models_keyboard("12_15k")
    if kb_from_json:
        return kb_from_json
...
def get_budget_15_20_models_keyboard() -> types.InlineKeyboardMarkup:
    kb_from_json = _get_auto_models_keyboard("15_20k")
    if kb_from_json:
        return kb_from_json
...
def get_budget_20_30_models_keyboard() -> types.InlineKeyboardMarkup:
    kb_from_json = _get_auto_models_keyboard("20_30k")
    if kb_from_json:
        return kb_from_json
...
def get_budget_30k_plus_models_keyboard() -> types.InlineKeyboardMarkup:
    kb_from_json = _get_auto_models_keyboard("30k_plus_lux")
    if kb_from_json:
        return kb_from_json
...
def get_best_deals_keyboard() -> types.InlineKeyboardMarkup:
    ...
    kb.button(text="✉️ Связаться с менеджером", callback_data="lead:contact_manager")
    kb.button(text="Назад", callback_data="best_deals:back")
    kb.adjust(1, 1, 1, 1)
    return kb.as_markup()

def get_electric_models_keyboard() -> types.InlineKeyboardMarkup:
    kb_from_json = _get_auto_models_keyboard("electric")
    if kb_from_json:
        return kb_from_json
...
def get_auto_model_actions_keyboard(category_id: str, model_id: str) -> types.InlineKeyboardMarkup:
    ...
    kb.button(text="📌На главную", callback_data="guarantees:home")
    kb.adjust(1, 1)
    return kb.as_markup()
...
def get_guarantees_risks_keyboard() -> types.InlineKeyboardMarkup:
    kb = InlineKeyboardBuilder()
    kb.button(text="✉️ Связаться с менеджером", callback_data="lead:contact_manager")
    kb.button(text="🔍 Подобрать авто", callback_data="lead:auto_pick")
    kb.button(text="🏍️ Подобрать мото", callback_data="lead:moto_pick")
    kb.button(text="📌 На главную", callback_data="guarantees:home")
    kb.adjust(1, 1, 1, 1)
    return kb.as_markup()
...
def get_quick_main_auction_keyboard() -> types.InlineKeyboardMarkup:
    kb = InlineKeyboardBuilder()
    kb.button(text="✉️Связаться с менеджером", callback_data="lead:contact_manager")
    kb.button(text="🔍 Подборки авто по ценам", callback_data="lead:auto_pick")
    kb.adjust(1, 1)
    return kb.as_markup()
...
def get_quick_main_delivery_keyboard() -> types.InlineKeyboardMarkup:
    ...
    kb.button(text="🔍 Подобрать авто", callback_data="lead:auto_pick")
    kb.button(text="🏍️ Подобрать мото", callback_data="lead:moto_pick")
    kb.button(text="Назад", callback_data="info:quick_main")
    kb.adjust(1, 1, 1, 1)
    return kb.as_markup()

def get_quick_main_credit_keyboard() -> types.InlineKeyboardMarkup:
    kb = InlineKeyboardBuilder()
    kb.button(text="✉️ Связаться с менеджером", callback_data="lead:contact_manager")
    kb.button(text="🔍 Подборки авто по ценам", callback_data="lead:auto_pick")
    kb.button(text="Назад", callback_data="info:quick_main")
...
def get_moto_classes_keyboard() -> types.InlineKeyboardMarkup:
    kb = InlineKeyboardBuilder()
    rows = []
